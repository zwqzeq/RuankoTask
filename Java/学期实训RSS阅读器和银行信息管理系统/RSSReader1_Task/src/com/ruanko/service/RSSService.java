...
public class RSSService {
	...
	public List<Channel> getchannelList() {
		if(channelList == null) {                                     //判断列表是否为空
			...
			channel1.setName("新华网 - 军事频道");                     //第一个频道名字
			channel1.setFilePath("NewsFiles/news_mil.xml");        //第一个频道地址

			Channel channel2 = new Channel();
			channel2.setName("环球网 - 国际热点");
			channel2.setFilePath("NewsFiles/hot.xml");
			...
			channelList.add(channel1);                     //将频道对象添加到列表中
